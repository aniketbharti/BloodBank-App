...
<div class="container">
 	...
 	<h1 class="linkd" style="margin-top: 3%">Update User Information</h1>
		<ol class="breadcrumb">
					...
					<div class="col-sm-4">
						<div class="col-sm-12">
							<div class="form-group">
								...
								<input type="text" name="fname" id="fname" value="<?php echo $row['name'];?>" class="form-control" required>
							</div>
						</div>
					</div>
					<div class="col-sm-4">
						<div class="col-sm-12">
							<div class="form-group">
								...
								<input type="email" name="email" id="email" value="<?php echo $row['email'];?>" readonly class="form-control" required>
							</div>
						</div>
					</div>
					<div class="col-sm-4">
                    ...
                    <div class="col-sm-4">
                         <div class="col-sm-12">
                              <div class="form-group">
                                   ...
                                   <input type="text" name="address" id="address" value="<?php echo $row['address'];?>" class="form-control" required>
                              </div>
                         </div>
                    </div>
                    <div class="col-sm-4">
                         <div class="col-sm-12">
                              <div class="form-group">
                                   ...
                                   <input type="text" name="street_name" value="<?php echo $row['street'];?>" id="street_name" class="form-control">
                              </div>
                         </div>
                    </div>
                    <div class="col-sm-4">
                    ...
                    <div class="col-sm-4">
                         <div class="col-sm-12">
                              <div class="form-group">
                                   ...
                                   <input type="tel" name="zipcode" class="form-control" value="<?php echo $row['zipcode'];?>" id="zipcode" minlength="6" maxlength="6" required>
                              </div>
                         </div>
                    </div>
                    <div class="col-sm-4">
					...
					<div class="col-sm-4">
						<div class="col-sm-12">
							<div class="form-group">
								...
								<input type="tel" name="number" id="number" class="form-control" value="<?php echo $row['contact_no'];?>" maxlength="10" minlength="8" required>
							</div>
						</div>
					</div>
				<div class="col-sm-4">
					<div class="col-sm-12">
						<div class="form-group">
							...
							<input type="tel" name="alt_number" id="alt_number" class="form-control" value="<?php echo $row['alt_contact_no'];?>" maxlength="10" minlength="8">
						</div>
					</div>
				</div>
				<div class="col-sm-4">
					<div class="col-sm-12">
						<div class="form-group">
							...
							<input type="email" name="alternate_email" id="alternate_email" value="<?php echo $row['alt_email'];?>" class="form-control">
						</div>
					</div>
				</div>
			</div>
...
if(isset($_POST['update'])) //Update Details
    {
		...
		$result=mysqli_query($dbconfig,"update user set name='$fname',sex='$sex',password='$password',address='$address',street='$street_name',city='$city',zipcode='$zipcode',state='$state',contact_no='$number',alt_contact_no='$alt_number',alt_email='$alternate_email' where email='$email'");
        	if($result)
        	echo"<script type=\"text/javascript\">alert('Updated Sucessfully')
				window.open(\"userprofile.php\",\"_self\")</script>";
			else
			echo"<script type=\"text/javascript\">alert('Error Encountered')
				window.open(\"userprofile.php\",\"_self\")</script>";
